...
-- ─── search_results ──────────────────────────────────────────────────────────
-- Note: purge_due_at uses DEFAULT instead of GENERATED ALWAYS AS because
-- timestamptz + interval is not considered immutable in all PG15 builds.
CREATE TABLE IF NOT EXISTS search_results (
    ...
    purge_due_at      TIMESTAMPTZ NOT NULL DEFAULT (NOW() + INTERVAL '90 days'),
